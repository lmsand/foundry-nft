...
contract MoodNftTest is Test {
    ...
    // declare our Happy and Sad SVG URIs as constants in our test, we can use these in the deployment of our MoodNft contract within the setUp function of our Test.
    MoodNft moodNft;
    ...
    function testViewTokenURI() public {
        // outcome: With the assurance that our tokenURI function is returning a correctly formatting string, for both our tokenURI itself _and_ our imageURI, I think we're ready to make this NFT dynamic!
        vm.prank(USER);
        moodNft.mintNft();
